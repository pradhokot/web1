               ...
               <div class="row fw-medium align-items-center justify-content-between">
                  <div class="col">
                     <div class="input-group align-items-center">
                        ...
                        <input class="form-control text-center p-0 h-auto border-left-0 border-top-0 border-right-0 bg-transparent" value="1" min="1" max="100" readonly style="font-size: 1.25rem; max-width: 50px;">
